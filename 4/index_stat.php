...
preg_match_all('/<main class="HKt8rc CGNRMc" jsname="fjw8sb">(?s).*<\/main>/', $lines_string, $body);
//print_r($body);
//echo htmlentities($body[0][0]);
//echo $body[0][0];
...
preg_match_all('/<h3 class="ipQwMb ekueJc RD0gLb"><a href="(.*?)" class="DY5T1d" >(.*?)<\/a><\/h3>/', $body[0][0], $some);
//print_r($some[0]);
//echo htmlentities($some[0][0]);

preg_match_all('/<img class="tvs3Id QwxBBf" srcset="(.*?)" aria-label="Image" alt="" src="(.*?)" id="i\d{1,3}" loading="lazy"\/>/', $body[0][0], $someimg);
//print_r($someimg);
